...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/6.2.6/css/tempus-dominus.min.css">
...
<body class="home-page home-01 ">
										...
										@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="Manage Home Slider" href="{{ route('admin.homeslider')}}">Mange Home Slider</a>
													</li>
													<li class="menu-item">
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/6.2.6/js/tempus-dominus.min.js"></script>
	...
	<script src="https://cdn.tiny.cloud/1/ch3rbvs8yfvua2jbaxdnwyq20hbb6rhislej5dv9s4f62jv5/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
